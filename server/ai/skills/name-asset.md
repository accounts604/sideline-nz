---
name: name-asset
description: Generate the canonical name for a product image, logo, or design file uploaded into Sideline NZ — so Drive folders, PO PDFs and supplier email attachments stay consistent and the Shopify Collection Autopilot's filename parser ingests them cleanly.
---
